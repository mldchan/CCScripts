...
while true do
    ...
    shell.run("wget https://raw.githubusercontent.com/Akatsuki2555/CCScripts/main/velkysmp/ticketserver/startup.lua startup.lua")
    fs.delete("json.lua")
    shell.run("wget https://raw.githubusercontent.com/rxi/json.lua/master/json.lua json.lua")
    fs.delete("main.lua")
    shell.run("wget https://raw.githubusercontent.com/Akatsuki2555/CCScripts/main/velkysmp/ticketserver/main.lua main.lua")
    fs.delete("utils.lua")
