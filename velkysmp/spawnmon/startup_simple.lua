...
function downloadFile()
    ...
    -- Get string
    local startupUpdate = http.get("https://mldkyt.nekoweb.org/cc/velkysmp/spawnmon/startup_simple.lua")
...
fs.delete("main.lua")
shell.run("wget https://mldkyt.nekoweb.org/cc/velkysmp/spawnmon/main_simple.lua main.lua")
